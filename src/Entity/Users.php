...
{   use CreatedAtTrait;
    ...
    #[Assert\NotBlank(message:'Le mail ne peut etre vide')]
    ...
    #[ORM\Column(length: 255)]
    #[Assert\NotBlank(message:'Le numero  ne peut etre vide')]
    ...
    #[ORM\ManyToMany(targetEntity: Reservations::class, mappedBy: 'users')]
